...
//    int int_part = (int)value; // Lấy phần nguyên
//    int decimal_part = (int)((value - int_part) * 10); // Lấy phần thập phân
//
...
//    buffer[len + 1] = '\0';
//
//    // Thêm phần thập phân vào chuỗi
//    char dec_char[2];
//    itoa(decimal_part, dec_char, 10);
//    strcat(buffer, dec_char); // Nối phần thập phân vào chuỗi
//}
